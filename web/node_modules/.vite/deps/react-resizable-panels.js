  ...
  switch (t.state) {
    case "active":
      te({
        cursorFlags: 0,
        state: "inactive"
      }), t.hitRegions.length > 0 && (xe(e), o = true, t.hitRegions.forEach((i) => {
        if (!n.has(i.group))
          return;
...
function qt({
  ...
  return q(() => {
    ...
    N.current = R;
    const M = Wt(R), { defaultLayoutDeferred: D, derivedPanelConstraints: U, layout: ue } = H(R.id, true);
    !D && U.length > 0 && (f(ue), d(ue, false));
    const oe = Pe(h, (_) => {
