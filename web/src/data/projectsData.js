// Ongoing and completed NetiaX installation projects.
// Add future projects by appending a new object to this array.
export const projects = [
  {
    id: 'kibwezi-pixie-drip-2026',
    title: '7-Acre Button Dripper Irrigation — Pixie Orchard',
    county: 'Makueni',
    location: 'Kibwezi',
    scope: '7 acre button dripper irrigation on pixie',
    description:
      'Full design and installation of a button-dripper drip irrigation system across a 7-acre pixie orange orchard in Kibwezi. The system includes mainline and sub-main pipework, filtration, fertigation-ready manifolds, and a button dripper on every tree for precise, water-efficient delivery suited to the semi-arid Makueni climate.',
    status: 'in_progress',
    startDate: '2026-06-15',
    targetDate: '2026-08-30',
    progress: 55,
    milestones: [
      { label: 'Site survey & design', done: true },
      { label: 'Mainline & sub-main installation', done: true },
      { label: 'Filtration & fertigation setup', done: false },
  ...
  },
  {
    ...
    title: '3 Metallic Greenhouses — Juja Installation',
    county: 'Kiambu',
    location: 'Juja',
    scope: '3 greenhouses measuring 8M x 30M each',
    description:
      'Complete construction and handover of three metallic-frame greenhouses (8m x 30m each) in Juja, Kiambu County. Each structure features a top vent for natural cooling and airflow, roll-up sides for climate control, and an entry porch, paired with a full drip irrigation network — mainline piping, sub-mains and in-line drippers — delivered to every row for efficient, precise watering.',
    status: 'completed',
    startDate: '2026-04-01',
    targetDate: '2026-07-10',
    progress: 100,
    milestones: [
      { label: 'Site preparation & layout marking', done: true },
      { label: 'Metallic frame construction (3 units)', done: true },
      { label: 'Top vent, roll-up sides & entry porch fitting', done: true },
